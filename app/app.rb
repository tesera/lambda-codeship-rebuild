...
class CodeshipRestartBuild
  ...
  def initialize
    @api_key = ENV['API_KEY'] || abort("Please provide your API Key as an environment variable: CODESHIP_API_KEY=YOUR_CODESHIP_API_KEY")
    @project_id = ENV['PROJECT_ID'] || abort("Please provide your project id as an environment variable: CODESHIP_API_PROJECT_ID=YOUR_CODESHIP_API_PROJECT_ID")
    @branch_name = ENV['BRANCH'] || abort("Please provide your branch name as an environment variable: CODESHIP_API_BRANCH=YOUR_CODESHIP_API_BRANCH")
